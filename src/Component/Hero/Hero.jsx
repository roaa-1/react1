...
import userHero from './../../assets/images/avataaars.svg';
...
function Hero() {
    return (
        ...
        <div className={style.imgHero}>
            <img src={userHero} alt='avatar' className={style.avatar} />
        </div>
        <div className={style.textHero}>
            ...
            <p className={style.subtitle}>Graphic Artist - Web Designer - Illustrator</p>
        </div>
